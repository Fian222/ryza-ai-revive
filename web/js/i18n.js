...
(function (global) {
  ...
  var T = {
    zh: {
      ...
      'settings.rim': '轮廓光',
      'settings.nsfwPermission': '成人向脱衣画面',
      ...
      'settings.fishBaseHint': '留空=官方 Fish API（https://api.fish.audio）。',
      'settings.fishModel': 'Fish 引擎模型',
      'settings.fishModel.hint': '作为 model 请求头发送的引擎 ID，默认 s2.1-pro-free。与音色 ID 不是同一个字段。',
      'settings.fishVoice': 'Fish reference_id',
      'settings.fishVoice.hint': '留空则用本地莱莎序章原声自动复刻。也可手填已有 reference_id，或点下面的复刻按钮。',
    ...
    ja: {
      ...
      'settings.rim': 'リムライト',
      'settings.nsfwPermission': '成人向けの脱衣表示',
      ...
      'settings.fishBaseHint': '空欄＝公式 Fish API（https://api.fish.audio）。',
      'settings.fishModel': 'Fish エンジンモデル',
      'settings.fishModel.hint': 'model ヘッダーとして送信するエンジン ID。初期値は s2.1-pro-free。音色 ID とは別欄です。',
      'settings.fishVoice': 'Fish reference_id',
      'settings.fishVoice.hint': '空欄ならローカルのライザ序章音声で自動クローン。既存の reference_id を手入力するか、下のボタンでも作成できます。',
    ...
    en: {
      ...
      'settings.nsfwPermission': 'NSFW / undress visuals',
      ...
      'settings.fishBaseHint': 'Empty = official Fish API (https://api.fish.audio).',
      'settings.fishModel': 'Fish engine model',
      'settings.fishModel.hint': 'Engine id sent in the model header; default s2.1-pro-free. Separate from the voice id.',
      'settings.fishVoice': 'Fish reference_id',
      'settings.fishVoice.hint': 'Leave empty to auto-clone from local Ryza prologue audio. Or paste an existing reference_id / tap clone below.',
